...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference("Comentario.count") do
      post comentarios_url, params: { comentario: { ar: @comentario.ar, contenido: @comentario.contenido, usuario_id: @comentario.usuario_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { ar: @comentario.ar, contenido: @comentario.contenido, usuario_id: @comentario.usuario_id } }
