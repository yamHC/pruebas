...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference("Categorium.count") do
      post categoria_url, params: { categorium: { descipcion: @categorium.descipcion, nombre: @categorium.nombre } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { descipcion: @categorium.descipcion, nombre: @categorium.nombre } }
